...
(function(){
  ...
  document.addEventListener('DOMContentLoaded',()=>{
    ...
    ['producto','variante','motorModelo','varianteMotorizado','colorDecorativo','medida','alturaCordon','ivaOpcional','cantidad','correderasExtraPct','instalacionTradTecho','soporteMuroTrad'].forEach(id=>{ if($(id)) $(id).addEventListener('input',syncSummary); if($(id)) $(id).addEventListener('change',syncSummary); });
